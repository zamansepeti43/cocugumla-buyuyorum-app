...
const BG = '/ChatGPT Image 20 Ağu 2026 02_31_03.png'
...
export function ForestWorldApp() {
  ...
  return (
    <main className="forest-app" aria-label="Doğa Dünyası">
      <style>{`
        .forest-app{position:fixed;inset:0;width:100vw;height:100dvh;overflow:hidden;background:#6cc8a7;font-family:system-ui,sans-serif;z-index:99999}
        .forest-bg{position:absolute;inset:0;width:100%;height:100%;object-fit:cover;object-position:center;z-index:0}
        .forest-shade{position:absolute;inset:0;background:linear-gradient(90deg,rgba(17,62,38,.18),transparent 45%,rgba(17,62,38,.08));z-index:1;pointer-events:none}
        ...
        .forest-next{position:absolute;right:5%;bottom:8%;z-index:9;border:0;border-radius:22px;padding:17px 30px;background:linear-gradient(#ffd952,#f1a62f);color:#713313;font-size:clamp(18px,2.1vw,28px);font-weight:900;box-shadow:0 9px 0 #c17a24;cursor:pointer}
      ...
      {intro ? (
        ...
        <div className="forest-map">
          <div className="forest-map-card">
            ...
            <button className="forest-next" style={{position:'static'}} onClick={() => setIntro(true)}>← Leo'ya dön</button>
          </div>
        </div>
      )}
    </main>

...
export function EnglishPage() {
  return (
    <div className="page english-page">
      <section className="english-hero"><div><span className="kicker">ENGLISH CLUB</span><h1>İngilizceyi oyunla keşfet.</h1><p>Yaşa uygun kelimeler, tekrarlar ve mini oyunlar için hazırlanan öğrenme alanı.</p><span className="coming-badge">Mini konuşma seti</span></div><div className="english-visual"><span>Hello!</span><strong>ABC</strong><i>⭐</i></div></section>
      ...
      <section className="future-panel"><LockKeyhole /><div><span className="kicker">YOL HARİTASINDA</span><h2>Çocuğunuza göre şekillenen bir program</h2><p>Dinleme, tekrar, mini hikâyeler, oyunlar ve basit konuşma çalışmaları bu alanın ilgi alanlarını zenginleştirir.</p></div></section>
    </div>
  )
}